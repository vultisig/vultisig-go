...
// Ethereum uses Keccak-256 with 0x01 domain separation, distinct from
// the NIST SHA3-256 finalisation which uses 0x06.
...
// This is NOT SHA3-256: it uses 0x01 padding, not 0x06.
func Keccak256(data []byte) [32]byte {
	...
	buf[remaining] = 0x01 // Keccak padding (not SHA3's 0x06)
	buf[rate-1] |= 0x80
