...
// bech32HRPExpand expands the HRP into values for checksum computation.
...
// bech32Encode encodes a bech32 string given the HRP and 5-bit data values.
...
// pad determines whether to pad the output.
...
// bech32ifyAddressBytes converts address bytes to a bech32 string with the given HRP.
func bech32ifyAddressBytes(hrp string, bs []byte) (string, error) {
	data, err := convertBits(bs, 8, 5, true)
	if err != nil {
